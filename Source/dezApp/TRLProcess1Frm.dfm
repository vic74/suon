object TRLProcess1Form: TTRLProcess1Form
  Left = 0
  Top = 0
  HelpContext = 111
  Caption = #1057#1086#1079#1076#1072#1085#1080#1077' '#1088#1072#1073#1086#1090' '#1090#1077#1082#1091#1097#1077#1075#1086' '#1088#1077#1084#1086#1085#1090#1072'('#1051#1080#1092#1090')'
  ClientHeight = 737
  ClientWidth = 1034
  Color = clBtnFace
  ...
  object lc1: TdxLayoutControl
    ...
    object grd1: TcxGrid
      ...
      Width = 988
      Height = 293
      Hint = #1053#1072#1078#1084#1080#1090#1077' F3 '#1076#1083#1103' '#1087#1077#1088#1077#1084#1077#1097#1077#1085#1080#1103' '#1079#1072#1087#1080#1089#1080
      TabOrder = 10
    ...
    object grd2: TcxGrid
      ...
      Width = 1012
      Height = 270
      Hint = #1053#1072#1078#1084#1080#1090#1077' F3 '#1076#1083#1103' '#1087#1077#1088#1077#1084#1077#1097#1077#1085#1080#1103' '#1079#1072#1087#1080#1089#1080' '#1074' '#1060#1072#1082#1090
      TabOrder = 11
  ...
  object ds_TRPLAN: TpFIBDataSet
    SelectSQL.Strings = (
      ...
      'left outer join MLIST M on M.CODE = TP.MLIST and m.MGROUP in (4)'
      ...
      'left join TRLFINPLAN TF on TF.Y = TP.Y and TF.HOUSE = TP.HOUSE')
    Transaction = cmDb.RT
    Database = cmDb.DB
