object AddJWorkForm: TAddJWorkForm
  Left = 0
  Top = 0
  ...
  object lc1: TdxLayoutControl
    ...
    object dt_FactDate: TcxDateEdit
      Left = 185
      Top = 277
      Enabled = False
      Style.HotTrack = False
    ...
    object grp_fakt: TdxLayoutGroup
    ...
    object itm_fakt: TdxLayoutItem
      CaptionOptions.Text = #1056#1072#1073#1086#1090#1072' '#1074#1099#1087#1086#1083#1085#1077#1085#1072
      Parent = grp_fakt
    ...
    object itm_FactDate: TdxLayoutItem
      AlignHorz = ahRight
      CaptionOptions.Text = #1060#1072#1082#1090'. '#1076#1072#1090#1072
      Parent = grp_fakt
      SizeOptions.AssignedValues = [sovSizableHorz, sovSizableVert]
      SizeOptions.SizableHorz = True
      SizeOptions.SizableVert = True
    ...
    object itm_note: TdxLayoutItem
      CaptionOptions.Text = #1054#1087#1080#1089#1072#1085#1080#1077' '#1074#1099#1087#1086#1083#1085#1077#1085#1099#1093' '#1088#1072#1073#1086#1090
      CaptionOptions.Layout = clTop
      Parent = grp1
      Control = mmo_Note
      ControlOptions.ShowBorder = False
