object TRLProcess6Form: TTRLProcess6Form
  Left = 0
  Top = 0
  HelpContext = 118
  Caption = #1054#1073#1098#1077#1082#1090#1085#1099#1081' '#1078#1091#1088#1085#1072#1083' '#1087#1086' '#1086#1088#1075#1072#1085#1080#1079#1072#1094#1080#1080' ('#1051#1080#1092#1090')'
  ClientHeight = 728
  ClientWidth = 850
  Color = clBtnFace
  ...
  object ds_TRFACT: TpFIBDataSet
    SelectSQL.Strings = (
      ...
      '  TF.NCALC, TF.NCALCDATE, TF.NSUMMA, TF.NDOP, TF.SUMMA, TF.NOTE,'
        ...
        '  TF.PLANCODE,TF.STATE,TF.TRLDOPSOG, td.code trldop, td.state TR' +
        'DOPSTATE,'
