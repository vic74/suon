object OsmForm: TOsmForm
  Left = 0
  Top = 0
  HelpContext = 102
  Caption = #1060#1080#1085#1072#1085#1089#1086#1074#1099#1081' '#1087#1083#1072#1085' '#1090#1077#1082#1091#1097#1080#1093' '#1088#1077#1084#1086#1085#1090#1086#1074
  ClientHeight = 640
  ClientWidth = 836
  Color = clBtnFace
    ...
    object grd1: TcxGrid
      ...
      object v1: TcxGridDBTableView
        ...
        object clvAllSum: TcxGridDBColumn
          Caption = #1055#1083#1072#1085' + '#1086#1089#1090#1072#1090#1086#1082
  ...
  object ds_plan: TpFIBDataSet
    ...
    SelectSQL.Strings = (
      ...
      '       tp.SUMY, tp.SUM1, tp.SUM2, tp.SUM3,'
      '       tp.SUM4, tp.SUMOST,'
      '       --iif(tp.SUMY+tp.SUMOST<0,0,tp.SUMY+tp.SUMOST) AllSum,'
      '       tp.SUMY+tp.SUMOST AllSum,'
      '       m.worker, (P.F || '#39' '#39' || P.I || '#39' '#39' || P.O) FIO'
      'FROM TRFINPLAN tp'
      'left outer join house h on h.code=tp.house'
      'left outer join street s on s.code=h.street'
      ...
      'left outer join PIPLE P on P.CODE = W.PIPLE'
      '')
    AutoUpdateOptions.UpdateTableName = 'TRFINPLAN'
