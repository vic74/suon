object FactBDR1Form: TFactBDR1Form
  Left = 0
  Top = 0
  Caption = #1060#1072#1082#1090' '#1041#1044#1056'1('#1086#1073#1097#1080#1081')'
  ClientHeight = 700
  ClientWidth = 807
  Color = clBtnFace
  ...
  object lc1: TdxLayoutControl
    ...
    object lgrplc1Group1: TdxLayoutGroup
      AlignHorz = ahClient
      AlignVert = avClient
      CaptionOptions.Text = #1060#1072#1082#1090' '#1041#1044#1056
  ...
  object brm1: TdxBarManager
    ...
    object brm1Bar1: TdxBar
      ...
      ItemLinks = <
        ...
        item
          BeginGroup = True
          Visible = True
          ItemName = 'btn_GetData'
        end
        item
          BeginGroup = True
          Visible = True
          ItemName = 'btn_ExportRep'
        end>
      NotDocking = [dsNone, dsLeft, dsTop, dsRight, dsBottom]
      OneOnRow = True
      Row = 0
    ...
    object itm_srv: TcxBarEditItem
      ...
      Properties.OnEditValueChanged = itm_srvPropertiesEditValueChanged
    end
    ...
    object btn_GetData: TdxBarButton
    ...
    object cbb_srv: TdxBarLookupCombo
      Caption = #1091#1089#1083#1091#1075#1072
      Category = 0
      Hint = #1091#1089#1083#1091#1075#1072
      Visible = ivAlways
      ...
      KeyField = 'CODE'
      ListField = 'NAME'
      ListSource = src__HOUSESRV
      RowCount = 7
      OnKeyValueChange = cbb_srvKeyValueChange
    end
    object btn_ExportRep: TdxBarButton
      Caption = #1069#1082#1089#1087#1086#1088#1090' '#1074' Excel'
      Category = 0
      Hint = #1069#1082#1089#1087#1086#1088#1090' '#1074' Excel'
      Visible = ivAlways
      ImageIndex = 16
      OnClick = btn_ExportRepClick
    end
  end
  ...
  object str1: TcxStyleRepository
    Left = 656
    Top = 216
    PixelsPerInch = 96
  ...
  object ds_HouseSrv: TpFIBDataSet
    SelectSQL.Strings = (
      'select * from HouseSrv where Code in (1,2,3,5,7,9,14)')
    Transaction = cmDb.RT
    Database = cmDb.DB
