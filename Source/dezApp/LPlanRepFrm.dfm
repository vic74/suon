object LPlanRepForm: TLPlanRepForm
  Left = 0
  Top = 0
  HelpContext = 107
  Caption = #1055#1083#1072#1085' '#1090#1077#1082#1091#1097#1077#1075#1086' '#1088#1077#1084#1086#1085#1090#1072' '#1083#1080#1092#1090
  ClientHeight = 671
  ClientWidth = 883
  Color = clBtnFace
  ...
  object lc1: TdxLayoutControl
    ...
    object grd1: TcxGrid
      ...
      object v1: TcxGridDBTableView
        ...
        DataController.Filter.OnBeforeChange = v1DataControllerFilterBeforeChange
  ...
  object ds_trplan: TpFIBDataSet
    SelectSQL.Strings = (
      ...
      'left outer join trlfinplan tf on tf.y=tp.y and tf.house=tp.house')
    Transaction = cmDb.RT
    Database = cmDb.DB
  ...
  object src_UNFORESEEN_L_EXP: TDataSource
    DataSet = ds_UNFORESEEN_L_EXP
    Left = 688
    Top = 608
  end
  object ds_UNFORESEEN_L_EXP: TpFIBDataSet
    SelectSQL.Strings = (
      'select ID, WORKER, QUART1, QUART2, QUART3, QUART4, Y'
      'from UNFORESEEN_L_EXP')
    Transaction = cmDb.RT
    Database = cmDb.DB
    UpdateTransaction = cmDb.WT
    Left = 720
