object CurRemTOForm: TCurRemTOForm
  Left = 0
  Top = 0
  Caption = #1043#1086#1076#1086#1074#1086#1081' '#1087#1083#1072#1085' '#1090#1077#1093'. '#1086#1073#1089#1083#1091#1078#1080#1074#1072#1085#1080#1103
  ClientHeight = 588
  ClientWidth = 858
  Color = clBtnFace
  ...
  object lc1: TdxLayoutControl
    ...
    object ce_sumy: TcxCurrencyEdit
      Left = 128
      Top = 362
    ...
    object ce_sumost: TcxCurrencyEdit
      Left = 10
      Top = 362
      Properties.DisplayFormat = ',0.00;-,0.00'
      Properties.ReadOnly = True
    ...
    object ce_sumfact: TcxCurrencyEdit
      Left = 225
      Top = 362
      Properties.ReadOnly = True
      Style.HotTrack = False
    ...
    object ce_proc: TcxCurrencyEdit
      Left = 10000
      Top = 10000
      Properties.DisplayFormat = ',0.00;-,0.00'
    ...
    object ce_proc4: TcxCurrencyEdit
      Left = 10000
      Top = 10000
    ...
    object ce_razn: TcxCurrencyEdit
      Left = 10000
      Top = 10000
      Properties.ReadOnly = True
      Style.HotTrack = False
    ...
    object ce_wsum: TcxCurrencyEdit
      Left = 319
      Top = 362
      Properties.DisplayFormat = ',0.00;-,0.00'
      Properties.ReadOnly = True
    ...
    object grd3: TcxGrid
      ...
      object v4: TcxGridDBTableView
        ...
        object clv4NOTE: TcxGridDBColumn
          ...
          Properties.ReadOnly = True
          Properties.OnButtonClick = clv4NOTEPropertiesButtonClick
    ...
    object cbb_SrvDog: TcxLookupComboBox
      ...
      Properties.OnEditValueChanged = cbb_SrvDogPropertiesEditValueChanged
      Style.HotTrack = False
      TabOrder = 1
      Width = 261
    end
    ...
    object litm__house: TdxLayoutItem
    ...
    object litm_grd1: TdxLayoutItem
      AlignHorz = ahClient
    ...
    object litm_sumost: TdxLayoutItem
    ...
    object litm_sumy: TdxLayoutItem
      AlignHorz = ahLeft
    ...
    object litm_sumfact: TdxLayoutItem
    ...
    object litm_wsum: TdxLayoutItem
    ...
    object litm_save: TdxLayoutItem
      CaptionOptions.Text = ' '
      CaptionOptions.Layout = clTop
      Parent = grp3
      Visible = False
    ...
    object litm_grd2: TdxLayoutItem
      AlignVert = avClient
      CaptionOptions.AlignVert = tavTop
    ...
    object litm_itm4: TdxLayoutItem
      AlignHorz = ahClient
      AlignVert = avClient
    ...
    object litm_razn: TdxLayoutItem
      CaptionOptions.Text = ' '
      CaptionOptions.Layout = clTop
      Visible = False
      SizeOptions.AssignedValues = [sovSizableHorz, sovSizableVert]
    ...
    object litm_proc: TdxLayoutItem
    ...
    object litm_itmlc1Item1: TdxLayoutItem
      CaptionOptions.Text = 'cxButton1'
      CaptionOptions.Visible = False
      Visible = False
      Control = btn1
  ...
  object ds_toplan: TpFIBDataSet
    ...
    SelectSQL.Strings = (
      ...
      'left outer join piple p on p.code = w.piple'
      '')
    AfterOpen = ds_toplanAfterOpen
    AfterPost = ds_toplanAfterPost
    Transaction = cmDb.RT
    Database = cmDb.DB
  ...
  object ds_house: TpFIBDataSet
    SelectSQL.Strings = (
      'select CODE, ADDRES from GETHOUSEBYSRVDOG(:DOG)')
    Transaction = cmDb.RT
    Database = cmDb.DB
    UpdateTransaction = cmDb.WT
    Left = 256
  ...
  object ds_dedail: TpFIBDataSet
    SelectSQL.Strings = (
      ...
      'left outer join mlist m on m.code=sh.mlist'
        ...
        '.house=:mas_house'
      '      and sh.RTYPE=0')
    BeforePost = ds_dedailBeforePost
    Transaction = cmDb.RT
    Database = cmDb.DB
    UpdateTransaction = cmDb.WT
    AutoCommit = True
  ...
  object ds_SrvDog: TpFIBDataSet
    SelectSQL.Strings = (
      'select fp.srvdog code, '#39#8470' '#39'||s.nomer||'#39'  {'#39'||k.name||'#39'}'#39' kontr'
      'from finplandate f'
      'left outer join finplan fp on fp.code = f.finplan'
      'left outer join srvdog s on s.code = fp.srvdog'
